document.addEventListener("DOMContentLoaded", () => {
  ...
  fetch(`${adresseIP}/backend/produits/`)
    ...
    .then(data => {
      ...
      const lienPanier = document.getElementById('nav-connexion');
      const popup = document.getElementById('popup-panier');
  
      if (lienPanier) {
        lienPanier.addEventListener('click', function (e) {
          e.preventDefault(); // évite le scroll en haut de page
          popup.style.display = 'block';
        });
      }
      ...
      if (btnDeconnexion){
        btnDeconnexion.addEventListener('click', function (e) {
          e.preventDefault();
          const token = localStorage.getItem('connexion');
          // console.log(token);
          fetch(`${adresseIP}/backend/deconnexion/`, {
            method: 'POST',
            headers : {
      ...
      // document.getElementById("nav-connexion").addEventListener('click', function(e) {
      //   e.preventDefault();
      ...
      document.getElementById("soumettrePanier").addEventListener('click', ()=>{
          ...
          const token = localStorage.getItem('connexion');
          fetch(`${adresseIP}/backend/enregistrerCommande/`, {
              method: 'POST',
              headers: {
